...
Section PROOF.
  ...
  Proof.
    ...
    { inv TGT. inv SRC. gstep. econs 3.
      inv SIM. inv REL. clarify. rewrite ! bind_trigger in *.
      inv H0. apply inj_pair2 in H2. eapply equal_f in H2.
      inv H1. apply inj_pair2 in H0. eapply equal_f in H0.
      rewrite H0, H2 in REL0. gfinal. left. eapply CIH. auto.
    }
    { inv TGT. inv SRC. gstep. econs 11. i. specialize (SIM _ _ EQ).
      inv SIM. inv REL. clarify. rewrite ! bind_trigger in *.
    ...
    { guclo simg_indC_spec. inv SIM.
      - econs; auto. des; eauto.
        ...
        + econs; auto. gstep. econs 10. gfinal; left. eauto. all: eapply Ord.S_lt.
        + des. econs; auto. eexists. gstep. econs 10. gfinal; left. eauto. all: eapply Ord.S_lt.
        + econs; auto. i. gstep. econs 10. gfinal; left. eauto. all: eapply Ord.S_lt.
