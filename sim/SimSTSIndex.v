...
Section SIM.
  ...
  Lemma _sim_ind2 sim (P: Ord.t -> Ord.t -> L0.(state) -> L1.(state) -> Prop)
        (FIN: forall
        ...
        (DMSRC: forall
            ...
            (SIM: exists st_src1 i_src1
                         (STEP: _.(step) st_src0 None st_src1)
              ,
                <<SIM: _sim sim i_src1 i_tgt0 st_src1 st_tgt0>> /\ <<IH: P i_src1 i_tgt0 st_src1 st_tgt0>>),
            P i_src0 i_tgt0 st_src0 st_tgt0)
        (DMTGT: forall
            i_src0 i_tgt0 st_src0 st_tgt0
            (SRT: _.(state_sort) st_tgt0 = demonic)
            (SIM: forall st_tgt1
                         (STEP: _.(step) st_tgt0 None st_tgt1),
                exists i_tgt1,
                <<SIM: _sim sim i_src0 i_tgt1 st_src0 st_tgt1>> /\ <<IH: P i_src0 i_tgt1 st_src0 st_tgt1>>),
            P i_src0 i_tgt0 st_src0 st_tgt0)
        (ANSRC: forall
            i_src0 i_tgt0 st_src0 st_tgt0
            (SRT: _.(state_sort) st_src0 = angelic)
        ...
        (PROGRESS:
           forall
             i_src0 i_tgt0 st_src0 st_tgt0 i_src1 i_tgt1
             (SIM: sim i_src1 i_tgt1 st_src0 st_tgt0)
             (SRC: Ord.lt i_src1 i_src0)
             (TGT: Ord.lt i_tgt1 i_tgt0),
             P i_src0 i_tgt0 st_src0 st_tgt0)
  ...
  Lemma sim_ind (P: Ord.t -> Ord.t -> L0.(state) -> L1.(state) -> Prop)
        (FIN: forall
            i_src0 i_tgt0 st_src0 st_tgt0
            retv
            (SRT: _.(state_sort) st_src0 = final retv)
        ...
        (DMSRC: forall
            ...
            (SIM: exists st_src1 i_src1
                         (STEP: _.(step) st_src0 None st_src1)
              ,
                <<SIM: sim i_src1 i_tgt0 st_src1 st_tgt0>> /\ <<IH: P i_src1 i_tgt0 st_src1 st_tgt0>>),
            P i_src0 i_tgt0 st_src0 st_tgt0)
        (DMTGT: forall
            i_src0 i_tgt0 st_src0 st_tgt0
            (SRT: _.(state_sort) st_tgt0 = demonic)
            (SIM: forall st_tgt1
                         (STEP: _.(step) st_tgt0 None st_tgt1),
                exists i_tgt1,
                <<SIM: sim i_src0 i_tgt1 st_src0 st_tgt1>> /\ <<IH: P i_src0 i_tgt1 st_src0 st_tgt1>>),
            P i_src0 i_tgt0 st_src0 st_tgt0)
        (ANSRC: forall
            i_src0 i_tgt0 st_src0 st_tgt0
            (SRT: _.(state_sort) st_src0 = angelic)
  ...
  Proof.
    ...
    intros i_src0. induction (Ord.lt_well_founded i_src0).
    rename x into i_src0. clear H. rename H0 into IHO.
  ...
  Proof.
    ...
    - (** done **)
      ...
      induction (Ord.lt_well_founded i_tgt0).
      rename x into i_tgt0. clear H. rename H0 into IHO.
      i. induction SIM using sim_ind; i; clarify.
    ...
    - (** cons **)
      ...
      induction (Ord.lt_well_founded i_tgt0).
      rename x into i_tgt0. clear H. rename H0 into IHO.
      i. induction SIM using sim_ind; i; try rewrite SRT in *; clarify.
      + (** vv **)
        specialize (SIM ev st1). apply SIM in STEP; clear SIM; des.
        gstep. econs 4; eauto. gbase. eapply CIH; eauto.
      + (** vis stuck **)
    ...
    - (** demonic **)
      ...
      + guclo of_state_indC_spec. econs 6; eauto. ii.
        exploit wf_angelic; et. i; clarify.
        hexploit SIM; eauto. i. des. splits; auto.
      + eapply IHO; eauto.
    - (** angelic **)
      red in STEP. des. clarify.
      revert i_src0 st_src0 SIM.
