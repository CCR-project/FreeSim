...
Require Import RelationClasses Relations.Operators_Properties.
...
Proof.
  hexploit (choice _ _ (fun a o => P a -> R a o)).
...
Definition double_rel_WF (A B: WF): WF := mk_wf (double_rel_well_founded A.(wf) B.(wf)).
